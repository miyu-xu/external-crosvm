...
use sys::platform;
pub use sys::platform::ioctl::ioctl;
pub use sys::platform::ioctl::ioctl_with_mut_ptr;
pub use sys::platform::ioctl::ioctl_with_mut_ref;
pub use sys::platform::ioctl::ioctl_with_ptr;
pub use sys::platform::ioctl::ioctl_with_ref;
pub use sys::platform::ioctl::ioctl_with_val;
pub use sys::platform::ioctl::IoctlNr;
...
pub use sys::platform::platform_timer_resolution::enable_high_res_timers;
use uuid::Uuid;
