...
pub const KVM_VM_TYPE_MASK: u32 = 2147483903;
...
pub const KVM_CAP_ARM_PROTECTED_VM: u32 = 4290435761;
...
pub const GZVM_IOC_SEQ_BASE: u32 = 146;
pub const GZVM_MAX_MEM_REGION: u32 = 1;
pub const GZVM_SMC_FUNC_CREATE_VM: ::std::os::raw::c_uint = 0;
pub const GZVM_SMC_FUNC_DESTROY_VM: ::std::os::raw::c_uint = 1;
pub const GZVM_SMC_FUNC_CREATE_VCPU: ::std::os::raw::c_uint = 2;
pub const GZVM_SMC_FUNC_DESTROY_VCPU: ::std::os::raw::c_uint = 3;
pub const GZVM_SMC_FUNC_SET_MEMREGION: ::std::os::raw::c_uint = 4;
pub const GZVM_SMC_FUNC_RUN: ::std::os::raw::c_uint = 5;
pub const GZVM_SMC_FUNC_GET_REGS: ::std::os::raw::c_uint = 6;
pub const GZVM_SMC_FUNC_SET_REGS: ::std::os::raw::c_uint = 7;
pub const GZVM_SMC_FUNC_GET_ONE_REG: ::std::os::raw::c_uint = 8;
pub const GZVM_SMC_FUNC_SET_ONE_REG: ::std::os::raw::c_uint = 9;
pub const GZVM_SMC_FUNC_IRQ_LINE: ::std::os::raw::c_uint = 10;
pub const GZVM_SMC_FUNC_CREATE_DEVICE: ::std::os::raw::c_uint = 11;
pub const NR_GZVM_SMC: ::std::os::raw::c_uint = 12;
...
#[repr(C)]
#[derive(Debug, Default, Copy, Clone)]
pub struct kvm_protected_vm_info {
    pub firmware_size: u64,
    pub __reserved: [u64; 7usize],
}
#[repr(C)]
#[derive(Debug, Default, Copy, Clone)]
...
pub struct cpu_user_regs {
    ...
    pub __bindgen_anon_19: cpu_user_regs__bindgen_ty_19,
    pub __bindgen_anon_20: cpu_user_regs__bindgen_ty_20,
    pub __bindgen_anon_21: cpu_user_regs__bindgen_ty_21,
    pub __bindgen_anon_22: cpu_user_regs__bindgen_ty_22,
    pub __bindgen_anon_23: cpu_user_regs__bindgen_ty_23,
    pub __bindgen_anon_24: cpu_user_regs__bindgen_ty_24,
    pub __bindgen_anon_25: cpu_user_regs__bindgen_ty_25,
    pub __bindgen_anon_26: cpu_user_regs__bindgen_ty_26,
    pub __bindgen_anon_27: cpu_user_regs__bindgen_ty_27,
    pub __bindgen_anon_28: cpu_user_regs__bindgen_ty_28,
    pub __bindgen_anon_29: cpu_user_regs__bindgen_ty_29,
    pub __bindgen_anon_30: cpu_user_regs__bindgen_ty_30,
    pub __bindgen_anon_31: cpu_user_regs__bindgen_ty_31,
    pub sp: u64,
    pub __bindgen_anon_32: cpu_user_regs__bindgen_ty_32,
    pub cpsr: u32,
    pub pad0: u32,
    pub __bindgen_anon_33: cpu_user_regs__bindgen_ty_33,
    pub pad1: u32,
    pub spsr_fiq: u32,
    pub spsr_irq: u32,
    pub spsr_und: u32,
    ...
    pub fp_regs: fpreg,
    pub vmm: vmm_info,
    pub context_guard: vcontext_guard,
}
#[repr(C)]
#[derive(Copy, Clone)]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub union cpu_user_regs__bindgen_ty_19 {
    pub x18: u64,
    pub lr_svc: u32,
}
impl Default for cpu_user_regs__bindgen_ty_19 {
    fn default() -> Self {
        let mut s = ::std::mem::MaybeUninit::<Self>::uninit();
        unsafe {
            ::std::ptr::write_bytes(s.as_mut_ptr(), 0, 1);
...
#[repr(C)]
#[derive(Copy, Clone)]
pub union cpu_user_regs__bindgen_ty_20 {
    pub x19: u64,
    pub sp_svc: u32,
}
impl Default for cpu_user_regs__bindgen_ty_20 {
    fn default() -> Self {
        let mut s = ::std::mem::MaybeUninit::<Self>::uninit();
        unsafe {
            ::std::ptr::write_bytes(s.as_mut_ptr(), 0, 1);
...
#[repr(C)]
#[derive(Copy, Clone)]
pub union cpu_user_regs__bindgen_ty_21 {
    pub x20: u64,
    pub lr_abt: u32,
}
impl Default for cpu_user_regs__bindgen_ty_21 {
    fn default() -> Self {
        let mut s = ::std::mem::MaybeUninit::<Self>::uninit();
        unsafe {
            ::std::ptr::write_bytes(s.as_mut_ptr(), 0, 1);
...
#[repr(C)]
#[derive(Copy, Clone)]
pub union cpu_user_regs__bindgen_ty_22 {
    pub x21: u64,
    pub sp_abt: u32,
}
impl Default for cpu_user_regs__bindgen_ty_22 {
    fn default() -> Self {
        let mut s = ::std::mem::MaybeUninit::<Self>::uninit();
        unsafe {
            ::std::ptr::write_bytes(s.as_mut_ptr(), 0, 1);
...
#[repr(C)]
#[derive(Copy, Clone)]
pub union cpu_user_regs__bindgen_ty_23 {
    pub x22: u64,
    pub lr_und: u32,
}
impl Default for cpu_user_regs__bindgen_ty_23 {
    fn default() -> Self {
        let mut s = ::std::mem::MaybeUninit::<Self>::uninit();
        unsafe {
            ::std::ptr::write_bytes(s.as_mut_ptr(), 0, 1);
...
#[repr(C)]
#[derive(Copy, Clone)]
pub union cpu_user_regs__bindgen_ty_24 {
    pub x23: u64,
    pub sp_und: u32,
}
impl Default for cpu_user_regs__bindgen_ty_24 {
    fn default() -> Self {
        let mut s = ::std::mem::MaybeUninit::<Self>::uninit();
        unsafe {
            ::std::ptr::write_bytes(s.as_mut_ptr(), 0, 1);
...
#[repr(C)]
#[derive(Copy, Clone)]
pub union cpu_user_regs__bindgen_ty_25 {
    pub x24: u64,
    pub r8_fiq: u32,
}
impl Default for cpu_user_regs__bindgen_ty_25 {
    fn default() -> Self {
        let mut s = ::std::mem::MaybeUninit::<Self>::uninit();
        unsafe {
            ::std::ptr::write_bytes(s.as_mut_ptr(), 0, 1);
...
#[repr(C)]
#[derive(Copy, Clone)]
pub union cpu_user_regs__bindgen_ty_26 {
    pub x25: u64,
    pub r9_fiq: u32,
}
impl Default for cpu_user_regs__bindgen_ty_26 {
    fn default() -> Self {
        let mut s = ::std::mem::MaybeUninit::<Self>::uninit();
        unsafe {
            ::std::ptr::write_bytes(s.as_mut_ptr(), 0, 1);
...
#[repr(C)]
#[derive(Copy, Clone)]
pub union cpu_user_regs__bindgen_ty_27 {
    pub x26: u64,
    pub r10_fiq: u32,
}
impl Default for cpu_user_regs__bindgen_ty_27 {
    fn default() -> Self {
        let mut s = ::std::mem::MaybeUninit::<Self>::uninit();
        unsafe {
            ::std::ptr::write_bytes(s.as_mut_ptr(), 0, 1);
...
#[repr(C)]
#[derive(Copy, Clone)]
pub union cpu_user_regs__bindgen_ty_28 {
    pub x27: u64,
    pub r11_fiq: u32,
}
impl Default for cpu_user_regs__bindgen_ty_28 {
    fn default() -> Self {
        let mut s = ::std::mem::MaybeUninit::<Self>::uninit();
        unsafe {
            ::std::ptr::write_bytes(s.as_mut_ptr(), 0, 1);
...
#[repr(C)]
#[derive(Copy, Clone)]
pub union cpu_user_regs__bindgen_ty_29 {
    pub x28: u64,
    pub r12_fiq: u32,
}
impl Default for cpu_user_regs__bindgen_ty_29 {
    fn default() -> Self {
        let mut s = ::std::mem::MaybeUninit::<Self>::uninit();
        unsafe {
            ::std::ptr::write_bytes(s.as_mut_ptr(), 0, 1);
...
#[repr(C)]
#[derive(Copy, Clone)]
pub union cpu_user_regs__bindgen_ty_30 {
    pub fp: u64,
    pub sp_fiq: u32,
}
impl Default for cpu_user_regs__bindgen_ty_30 {
    fn default() -> Self {
        let mut s = ::std::mem::MaybeUninit::<Self>::uninit();
        unsafe {
            ::std::ptr::write_bytes(s.as_mut_ptr(), 0, 1);
...
#[repr(C)]
#[derive(Copy, Clone)]
pub union cpu_user_regs__bindgen_ty_31 {
    pub lr: u64,
    pub lr_fiq: u32,
}
impl Default for cpu_user_regs__bindgen_ty_31 {
    fn default() -> Self {
        let mut s = ::std::mem::MaybeUninit::<Self>::uninit();
        unsafe {
            ::std::ptr::write_bytes(s.as_mut_ptr(), 0, 1);
...
#[repr(C)]
#[derive(Copy, Clone)]
pub union cpu_user_regs__bindgen_ty_32 {
    pub pc: u64,
    pub pc32: u32,
}
impl Default for cpu_user_regs__bindgen_ty_32 {
    fn default() -> Self {
        let mut s = ::std::mem::MaybeUninit::<Self>::uninit();
        unsafe {
            ::std::ptr::write_bytes(s.as_mut_ptr(), 0, 1);
...
#[repr(C)]
#[derive(Copy, Clone)]
pub union cpu_user_regs__bindgen_ty_33 {
    pub spsr_el1: u32,
    pub spsr_svc: u32,
}
impl Default for cpu_user_regs__bindgen_ty_33 {
    fn default() -> Self {
        let mut s = ::std::mem::MaybeUninit::<Self>::uninit();
        unsafe {
            ::std::ptr::write_bytes(s.as_mut_ptr(), 0, 1);
...
pub struct gzvm_vcpu_run__bindgen_ty_1__bindgen_ty_1 {
    pub phys_addr: u64,
    pub data: gzvm_vcpu_run__bindgen_ty_1__bindgen_ty_1__bindgen_ty_1,
    pub size: u64,
    pub reg_nr: ::std::os::raw::c_int,
    pub is_write: bool,
}
#[repr(C)]
#[derive(Copy, Clone)]
pub union gzvm_vcpu_run__bindgen_ty_1__bindgen_ty_1__bindgen_ty_1 {
    pub c: u8,
    pub s: u16,
    pub w: u32,
    pub dw: u64,
}
impl Default for gzvm_vcpu_run__bindgen_ty_1__bindgen_ty_1__bindgen_ty_1 {
    fn default() -> Self {
        let mut s = ::std::mem::MaybeUninit::<Self>::uninit();
        unsafe {
            ::std::ptr::write_bytes(s.as_mut_ptr(), 0, 1);
...
impl Default for gzvm_vcpu_run__bindgen_ty_1__bindgen_ty_1 {
    fn default() -> Self {
        let mut s = ::std::mem::MaybeUninit::<Self>::uninit();
        unsafe {
            ::std::ptr::write_bytes(s.as_mut_ptr(), 0, 1);
...
pub struct gzvm_memory_region {
    pub slot: u32_,
    pub constituent_cnt: u32_,
    pub total_pages: u64_,
    pub gpa: u64_,
