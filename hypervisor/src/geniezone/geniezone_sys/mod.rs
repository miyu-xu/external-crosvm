...
pub mod aarch64 {
    ...
    ioctl_iow_nr!(GZVM_SET_MEMORY_REGION, GZVM_IOC_MAGIC, 0x40, gzvm_memory_region);
    ioctl_iow_nr!(GZVM_GET_DIRTY_LOG, GZVM_IOC_MAGIC, 0x42, gzvm_dirty_log);
    ioctl_iow_nr!(GZVM_SET_USER_MEMORY_REGION, GZVM_IOC_MAGIC, 0x46, gzvm_userspace_memory_region);
    ...
    ioctl_iow_nr!(GZVM_SET_GSI_ROUTING, GZVM_IOC_MAGIC, 0x6a, gzvm_irq_routing);
    ...
    ioctl_iow_nr!(GZVM_ARM_VCPU_INIT, GZVM_IOC_MAGIC, 0xae, gzvm_vcpu_init);
