...
pub const GZVM_VM_TYPE_ARM_IPA_SIZE_MASK: u32 = 255;
pub const GZVM_VM_TYPE_ARM_PROTECTED: u32 = 2147483648;
pub const GZVM_VM_TYPE_MASK: u32 = 2147483903;
pub const GZVM_IOC_MAGIC: u32 = 146;
pub const GZVM_CAP_ARM_VM_IPA_SIZE: u32 = 165;
pub const GZVM_CAP_ARM_PTRAUTH_ADDRESS: u32 = 171;
pub const GZVM_CAP_ARM_PTRAUTH_GENERIC: u32 = 172;
...
pub const GZVM_ARM_MAX_DBG_REGS: u32 = 16;
pub const GZVM_CAP_ARM_PROTECTED_VM_FLAGS_SET_FW_IPA: u32 = 0;
pub const GZVM_CAP_ARM_PROTECTED_VM_FLAGS_INFO: u32 = 1;
...
pub const GZVM_ARM_TARGET_GENERIC_V8: u32 = 5;
pub const GZVM_MEM_LOG_DIRTY_PAGES: u32 = 1;
pub const GZVM_MEM_READONLY: u32 = 2;
pub const GZVM_ARM_VCPU_POWER_OFF: u32 = 0;
pub const GZVM_ARM_VCPU_EL1_32BIT: u32 = 1;
pub const GZVM_ARM_VCPU_PSCI_0_2: u32 = 2;
pub const GZVM_ARM_VCPU_PMU_V3: u32 = 3;
pub const GZVM_ARM_VCPU_SVE: u32 = 4;
pub const GZVM_ARM_VCPU_PTRAUTH_ADDRESS: u32 = 5;
pub const GZVM_ARM_VCPU_PTRAUTH_GENERIC: u32 = 6;
...
pub const GZVM_REG_ARM_FW: u32 = 1310720;
...
pub struct gzvm_vcpu_run__bindgen_ty_1__bindgen_ty_6 {
    pub type_: u32,
    pub ndata: u32,
    pub __bindgen_anon_1: gzvm_vcpu_run__bindgen_ty_1__bindgen_ty_6__bindgen_ty_1,
}
#[repr(C)]
#[derive(Copy, Clone)]
pub union gzvm_vcpu_run__bindgen_ty_1__bindgen_ty_6__bindgen_ty_1 {
    pub flags: u64,
    pub data: [u64; 16usize],
}
impl Default for gzvm_vcpu_run__bindgen_ty_1__bindgen_ty_6__bindgen_ty_1 {
    fn default() -> Self {
...
impl Default for gzvm_vcpu_run__bindgen_ty_1__bindgen_ty_6 {
    fn default() -> Self {
        let mut s = ::std::mem::MaybeUninit::<Self>::uninit();
        unsafe {
            ::std::ptr::write_bytes(s.as_mut_ptr(), 0, 1);
...
pub struct gzvm_signal_mask {
    pub len: u32,
    pub sigset: __IncompleteArrayField<u8>,
}
#[repr(C)]
#[derive(Debug, Default, Copy, Clone)]
pub struct gzvm_mp_state {
    pub mp_state: u32,
}
#[repr(C)]
#[derive(Debug, Default, Copy, Clone)]
pub struct gzvm_guest_debug_arch {
...
#[repr(C)]
#[derive(Debug, Default, Copy, Clone)]
pub struct gzvm_guest_debug {
    pub control: u32,
    pub pad: u32,
    pub arch: gzvm_guest_debug_arch,
}
#[repr(C)]
#[derive(Debug, Default, Copy, Clone)]
pub struct gzvm_vcpu_events {
    pub exception: gzvm_vcpu_events__bindgen_ty_1,
    pub reserved: [u32; 12usize],
}
#[repr(C)]
#[derive(Debug, Default, Copy, Clone)]
pub struct gzvm_vcpu_events__bindgen_ty_1 {
...
impl Default for gzvm_enable_cap {
    fn default() -> Self {
        let mut s = ::std::mem::MaybeUninit::<Self>::uninit();
        unsafe {
            ::std::ptr::write_bytes(s.as_mut_ptr(), 0, 1);
...
#[repr(C)]
#[derive(Debug, Default, Copy, Clone)]
pub struct gzvm_enc_region {
    pub addr: u64,
    pub size: u64,
}
#[repr(C)]
#[derive(Copy, Clone)]
pub struct gzvm_clear_dirty_log {
    pub slot: u32,
    pub num_pages: u32,
    pub first_page: u64,
    pub __bindgen_anon_1: gzvm_clear_dirty_log__bindgen_ty_1,
}
#[repr(C)]
#[derive(Copy, Clone)]
pub union gzvm_clear_dirty_log__bindgen_ty_1 {
    pub dirty_bitmap: *mut ::std::os::raw::c_void,
    pub padding2: u64,
}
impl Default for gzvm_clear_dirty_log__bindgen_ty_1 {
    fn default() -> Self {
        let mut s = ::std::mem::MaybeUninit::<Self>::uninit();
        unsafe {
            ::std::ptr::write_bytes(s.as_mut_ptr(), 0, 1);
...
impl Default for gzvm_clear_dirty_log {
    fn default() -> Self {
        let mut s = ::std::mem::MaybeUninit::<Self>::uninit();
        unsafe {
            ::std::ptr::write_bytes(s.as_mut_ptr(), 0, 1);
