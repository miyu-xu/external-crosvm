...
use crate::geniezone::geniezone_sys::aarch64::*;
...
impl Geniezone {
    ...
    pub fn get_vcpu_mmap_size(&self) -> Result<usize> {
        // Safe because we know that our file is a GZVM fd and we verify the return result.
...
impl Vm for GeniezoneVm {
    ...
    fn check_capability(&self, c: VmCap) -> bool {
        ...
        match c {
            VmCap::DirtyLog => true,
            VmCap::PvClock => false,
            VmCap::PvClockSuspend => self.check_raw_capability(GeniezoneCap::KvmclockCtrl),
