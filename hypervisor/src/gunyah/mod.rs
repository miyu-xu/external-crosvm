...
impl GunyahCma {
    ...
    pub fn create_cma_memory_region(
        ...
        let region = MemoryRegion::new_cma_from_file_with_option(size, guest_addr, 0, file, option)
...
impl GunyahVm {
    ...
    pub fn set_vm_auth_type_to_qcom_trusted_vm(&self, payload_start: GuestAddress, payload_size: u64) -> Result<()> {
        ...
        let mut vm_name: [u8; GUNYAH_MAX_QTVM_NAME as usize] = [0; GUNYAH_MAX_QTVM_NAME as usize];
        vm_name[..name.len()].copy_from_slice(name.as_bytes());
