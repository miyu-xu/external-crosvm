...
mod tests {
    ...
    fn snapshot_restore_2d_no_resources() {
        ...
        rutabaga1.snapshot(&mut buffer, snapshot_dir.path()).unwrap();

        let mut rutabaga1 = new_2d();
        rutabaga1.restore(&mut &buffer.get_ref()[..], snapshot_dir.path()).unwrap();
    }
    ...
    fn snapshot_restore_2d_one_resource() {
        ...
        rutabaga2.restore(&mut &buffer.get_ref()[..], snapshot_dir.path()).unwrap();
