...
const RUTABAGA_GRALLOC_BACKEND_UNDEFINED: u32 = 0;
...
impl RutabagaGrallocBackendFlags {
    ...
    pub fn new() -> RutabagaGrallocBackendFlags {
        RutabagaGrallocBackendFlags(0)
    }

    #[inline(always)]
    pub fn use_system(self, e: bool) -> RutabagaGrallocBackendFlags {
        if e {
            RutabagaGrallocBackendFlags(self.0 | RUTABAGA_GRALLOC_BACKEND_SYSTEM)
        } else {
            RutabagaGrallocBackendFlags(self.0 & !RUTABAGA_GRALLOC_BACKEND_SYSTEM)
        }
    }
    ...
    pub fn undefined(&self) -> bool {
        self.0 == RUTABAGA_GRALLOC_BACKEND_UNDEFINED
    }
}
...
impl RutabagaGralloc {
    ...
    pub fn new(flags: RutabagaGrallocBackendFlags) -> RutabagaResult<RutabagaGralloc> {
        ...
        if flags.uses_system() || flags.undefined() {
