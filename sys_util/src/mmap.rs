...
/// ExternallyMappedHostMemory represents an existing buffer in the current address space for purposes
...
/// ExternallyMappedHostMemory uses a trait object `ExternallyMappedHostMemory` that performs device
