...
fn build(
    ...
    base::error!("jasonjason {:?} VirtioGpu::build() - display done", std::time::SystemTime::now());

    let ret = VirtioGpu::new(
        display,
        display_params,
        display_event,
        rutabaga_builder,
    ...
    base::error!("jasonjason {:?} VirtioGpu::build() - done", std::time::SystemTime::now());
    ret
}
...
impl VirtioDevice for Gpu {
    ...
    fn activate(
        ...
        base::error!("jasonjason {:?} VirtioGpu::activate()", std::time::SystemTime::now());
        ...
        self.worker_thread = Some(WorkerThread::start("v_gpu", move |kill_evt| {
            ...
            base::error!("jasonjason {:?} VirtioGpu WorkerThread::start() building gpu", std::time::SystemTime::now());
            ...
            base::error!("jasonjason {:?} VirtioGpu WorkerThread::start() built gpu", std::time::SystemTime::now());
        ...
        base::error!("jasonjason {:?} VirtioGpu::activate() - done", std::time::SystemTime::now());
