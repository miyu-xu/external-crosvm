...
impl VirtioGpu {
    ...
    pub fn set_scanout(
        ...
        /// Observation is when fall back, host receives set_scanout 0 0, and then
        /// set scanout 0 <some valid resid>.
        /// The first 0 0 removes the surface, the second creates a new surface
        /// with id++, which will be more than 0 and be ingorned in vnc or webrtc
        let resource = self
            .resources
            .get_mut(&resource_id)
