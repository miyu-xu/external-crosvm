...
impl Scmi {
    ...
    pub fn new(vhost_scmi_device_path: &PathBuf, base_features: u64) -> Result<Scmi> {
        ...
        let avail_features = base_features
            | 1 << virtio_sys::virtio_config::VIRTIO_SCMI_F_P2A_CHANNELS
            | 1 << virtio_sys::virtio_ring::VIRTIO_RING_F_EVENT_IDX
            | 1 << virtio_sys::virtio_config::VIRTIO_F_NOTIFY_ON_EMPTY
            | 1 << virtio_sys::virtio_config::VIRTIO_F_ANY_LAYOUT
            | 1 << virtio_sys::virtio_config::VIRTIO_F_VERSION_1;
...
impl VirtioDevice for Scmi {
    ...
    fn read_config(&self, offset: u64, data: &mut [u8]) {
        let dev_enable = Le64::from(self.dev_enable);
        copy_config(data, 0, DataInit::as_slice(&dev_enable), offset);
    }
