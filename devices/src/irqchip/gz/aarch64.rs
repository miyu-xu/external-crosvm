...
use hypervisor::gz::gzvm_create_device;
use hypervisor::gz::GZVM_DEV_TYPE_ARM_VGIC_V3_DIST;
use hypervisor::gz::GZVM_DEV_TYPE_ARM_VGIC_V3_REDIST;
...
pub struct GzKernelIrqChip {
    pub(super) vm: GzVm,
    pub(super) vcpus: Arc<Mutex<Vec<Option<GzVcpu>>>>,
...
impl GzKernelIrqChip {
    /// Construct a new KvmKernelIrqchip.
    pub fn new(vm: GzVm, num_vcpus: usize) -> Result<GzKernelIrqChip> {
        ...
        vm.create_gz_device(device_dis);
        ...
        vm.create_gz_device(device_redis);
...
impl IrqChipAArch64 for GzKernelIrqChip {
