...
impl IrqChip for GeniezoneKernelIrqChip {
    ...
    /// For the GeniezoneKernelIrqChip this simply calls the KVM_SET_IRQ_LINE ioctl.
    ...
    /// never exit with the KVM_EXIT_EOI_BROADCAST reason when an in-kernel irqchip exists.
