...
use hypervisor::geniezone::gzvm_device_type_GZVM_DEV_TYPE_ARM_VGIC_V3_DIST;
use hypervisor::geniezone::gzvm_device_type_GZVM_DEV_TYPE_ARM_VGIC_V3_REDIST;
...
impl GeniezoneKernelIrqChip {
    ...
    pub fn new(vm: GeniezoneVm, num_vcpus: usize) -> Result<GeniezoneKernelIrqChip> {
        ...
        let device_dis = gzvm_create_device {
            type_: gzvm_device_type_GZVM_DEV_TYPE_ARM_VGIC_V3_DIST,
            id: 0,
            flags: 0,
        ...
        let device_redis = gzvm_create_device {
            type_: gzvm_device_type_GZVM_DEV_TYPE_ARM_VGIC_V3_REDIST,
            id: 0,
            flags: 0,
