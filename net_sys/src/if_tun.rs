...
fn bindgen_test_layout_tun_pi() {
    ...
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<tun_pi>())).flags as *const _ as usize },
        0usize,
        concat!(
            "Offset of field: ",
            stringify!(tun_pi),
    ...
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<tun_pi>())).proto as *const _ as usize },
        2usize,
        concat!(
            "Offset of field: ",
            stringify!(tun_pi),
...
fn bindgen_test_layout_tun_filter() {
    ...
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<tun_filter>())).flags as *const _ as usize },
        0usize,
        concat!(
            "Offset of field: ",
    ...
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<tun_filter>())).count as *const _ as usize },
        2usize,
        concat!(
            "Offset of field: ",
            stringify!(tun_filter),
    ...
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<tun_filter>())).addr as *const _ as usize },
        4usize,
        concat!(
            "Offset of field: ",
            stringify!(tun_filter),
